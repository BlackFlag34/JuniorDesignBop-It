...
void receiveLoRa()
{
  ...
  if ( lora.available() > 0 )
  {
    ...
    Serial.println(transmissionNumber);
    ...
    if ((transmissionType == "CC")&&(characterSelect == 1)){ displayGameBegin(F("Knight"));  gameStart = false; }
    else if ((transmissionType == "CC")&&(characterSelect == 2)){ displayGameBegin(F("Mage"));  gameStart = false; }
    else if ((transmissionType == "CC")&&(characterSelect == 3)){ displayGameBegin(F("Archer"));  gameStart = false; }
