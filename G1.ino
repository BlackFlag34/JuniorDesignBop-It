...
void sendIR()
{
  if (gameStart == true)
  {
    if (characterSelect == 1){ IR_hexValue = 0x1B; }
    else if (characterSelect == 2){ IR_hexValue = 0x01; }
    else if (characterSelect == 3){ IR_hexValue = 0x02; } 
  }
  else
  {
    if ((characterSelect == 1)&&(smiteStatus == true)){ IR_hexValue = 0x03; }
    else if ((characterSelect == 1)&&(smiteStatus == false)){ IR_hexValue = 0x04; }
    else if ((characterSelect == 2)&&(fireballStatus == true)){ IR_hexValue = 0x05; }
    else if ((characterSelect == 2)&&(fireballStatus == false)){ IR_hexValue = 0x06; }
    else if ((characterSelect == 3)&&(arrowStatus == true)){ IR_hexValue = 0x07; }
    else if ((characterSelect == 3)&&(arrowStatus == false)){ IR_hexValue = 0x08; }
  }  
...
void receiveLoRa()
{
  ...
  if ( lora.available() > 0 )
  {
    ...
    if ((actionCode_1 != actionCode_2)&&(actionCode_1 != actionCode_3)&&(actionCode_2 != actionCode_3))
    {
      ...
      {
        if ((transmissionType == "R")&&(actionCode_1 == "K")&&(roundNumber.toDouble() == (lastRound+1)))
        { 
          action = 1; 
        ...
        else if ((transmissionType == "R")&&(actionCode_1 == "M")&&(roundNumber.toDouble() == (lastRound+1)))
        {
          action = 2;
          monsterRound = roundNumber.toDouble();
          // for (int i=0 ; i <= 1 ; i++)
        ...
        else if ((transmissionType == "R")&&(actionCode_1 == "S")&&(roundNumber.toDouble() == (lastRound+1)))
        {
          action = 3;
          monsterRound = roundNumber.toDouble();
          // for (int i=0 ; i <= 1 ; i++)
