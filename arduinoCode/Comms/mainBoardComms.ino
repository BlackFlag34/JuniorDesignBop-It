...
void loop() 
{
  while (digitalRead(readyRound) == LOW){Serial.println(F("Round Not Initialized"));}
  while (digitalRead(readyRound) == HIGH){Serial.println(F("Round Not Initialized 2"));}
  if (digitalRead(readyRound) == LOW){
...
void getCharacterTypes()
{
  if (numChars == 3){
    ...
    if ((specialLight_1 == HIGH)&&(specialLight_2 == HIGH)&&(specialLight_3)){
      digitalWrite(specialLight_1, LOW);
      digitalWrite(specialLight_2, LOW);
      digitalWrite(specialLight_3, LOW);}
  }
